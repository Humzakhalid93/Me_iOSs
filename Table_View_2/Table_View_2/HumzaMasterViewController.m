...
@interface HumzaMasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation HumzaMasterViewController
...
//    }
    HumzaDetailViewController *detailController =segue.destinationViewController;
